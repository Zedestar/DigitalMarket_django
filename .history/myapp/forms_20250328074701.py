...
class ProductForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(attrs={"class": "w-full px-1 py-2 border border-gray-300 rounded-md focus:ring focus:ring-green-400", "placeholder": "Enter product name",  "style": "placeholder-color: #9CA3AF; font-style: italic;"}),
